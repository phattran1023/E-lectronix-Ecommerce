...
(7, 'Red', 'red', '0', '2023-09-09 12:11:31', '2023-09-09 12:11:31');
...
INSERT INTO `comments` (`id`, `post_id`, `user_id`, `user_name`, `comment_body`, `created_at`, `updated_at`) VALUES
(1, 1, 2, '', 'Hello world', '2023-08-08 06:30:20', '2023-08-08 06:30:20'),
(3, 8, 2, '', 'hmm', '2023-08-15 04:19:49', '2023-08-15 04:19:49'),
(5, 30, 1, 'Admin', '289K mat qua', '2023-09-09 11:16:02', '2023-09-09 11:16:02');
...
(1, 1, 4, '2023-09-09 11:04:12', '2023-09-09 11:04:12'),
(2, 2, 6, '2023-09-09 11:17:24', '2023-09-09 11:17:24'),
(3, 1, 6, '2023-09-09 11:18:12', '2023-09-09 11:18:12'),
(4, 1, 7, '2023-09-09 11:20:44', '2023-09-09 11:20:44'),
(5, 1, 5, '2023-09-09 11:20:46', '2023-09-09 11:20:46'),
(8, 2, 8, '2023-09-09 12:03:00', '2023-09-09 12:03:00');
...
(9, 1, NULL, 5, '2023-08-06 02:05:44', '2023-08-19 05:30:23'),
(10, 1, 2, 4, '2023-08-06 02:05:44', '2023-09-05 11:12:52'),
(13, 12, NULL, 9, '2023-08-26 12:14:55', '2023-08-26 12:14:55'),
...
INSERT INTO `replies` (`id`, `origin_comment_id`, `user_id`, `user_name`, `comment_owner`, `reply_body`, `created_at`, `updated_at`) VALUES
(1, 4, 1, 'Admin', 'Admin', 'no', '2023-09-09 11:04:03', '2023-09-09 11:04:03'),
(3, 6, 1, 'Admin', 'Phat', 'ok bạn ib tôi', '2023-09-09 11:18:09', '2023-09-09 11:18:09'),
(4, 5, 1, 'Admin', 'Admin', 'không bình thường', '2023-09-09 11:18:24', '2023-09-09 11:18:24'),
(5, 7, 2, 'Phat', 'Admin', 'Real or fake ?', '2023-09-09 11:19:58', '2023-09-09 11:19:58'),
(6, 7, 1, 'Admin', 'Admin', 'Real nha bạn', '2023-09-09 11:20:37', '2023-09-09 11:20:37'),
(7, 7, 2, 'Phat', 'Admin', 'Hello', '2023-09-09 12:03:27', '2023-09-09 12:03:27'),
(8, 5, 2, 'Phat', 'Admin', 'hi', '2023-09-09 12:06:59', '2023-09-09 12:06:59');
...
INSERT INTO `reply_likes` (`id`, `user_id`, `reply_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2023-09-09 11:04:10', '2023-09-09 11:04:10'),
(2, 2, 2, '2023-09-09 11:16:42', '2023-09-09 11:16:42'),
(3, 1, 6, '2023-09-09 11:20:44', '2023-09-09 11:20:44'),
(4, 1, 4, '2023-09-09 11:20:46', '2023-09-09 11:20:46'),
(7, 2, 8, '2023-09-09 12:07:03', '2023-09-09 12:07:03'),
(8, 2, 4, '2023-09-09 12:07:04', '2023-09-09 12:07:04');
...
CREATE TABLE `reported_comment` (
  ...
  `violence` tinyint(4) DEFAULT 0,
  `hate` tinyint(4) DEFAULT 0,
  `suicide` tinyint(4) DEFAULT 0,
  `misinformation` tinyint(4) DEFAULT 0,
  `frauds` tinyint(4) DEFAULT 0,
  `deceptive` tinyint(4) DEFAULT 0,
  `else` varchar(50) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `reported_comment` (`id`, `report_id`, `comment_owner`, `user_comment`, `violence`, `hate`, `suicide`, `misinformation`, `frauds`, `deceptive`, `else`, `created_at`, `updated_at`) VALUES
(50, 4, 'Admin', 'hmm', 1, 0, 0, 0, 0, 0, NULL, '2023-09-09 11:07:49', '2023-09-09 11:07:49');
...
(1, 'Admin', 'admin@gmail.com', NULL, '$2y$10$xh4uMnrLrYonVbsFRVLvKeMDua1MYF9Iu0E/UeN0Ucf3ZXN88jt.6', 'QHUQLz2dDBJkjlfQYF50Znz5obMgti6jwT8rRQLy0VqXr8rnOHVEk0VKaPba', '2023-07-25 19:19:17', '2023-08-15 04:09:35', 1),
(2, 'Phat', 'ptrnvnh@gmail.com', NULL, '$2y$10$mF0dGSU8RqVh/3k95MuvLuIh/B5BJ3oY0hYjAu.XLb1MGEQkIzmqa', 'AUHp61stdk2gfDBMJegm3DObMeoz2mZEQQHNcfssFRD3yCLvS5pVpE4pzEKy', '2023-07-25 19:20:04', '2023-09-09 12:31:27', 0),
